...
<div class="relative bg-cover bg-center h-screen" style="background-image: url('./assetes/images/bg1.png');">
  ...
  <div class="w-full bg-black flex flex-col justify-center items-center pt-12">
    ...
    <div class="w-full flex flex-col justify-center items-center mb-20">
      <p class="text-sm md:text-xl lora- italic font-bold text-[#B9C37B]">Explore the breathtaking beauty, rich culture, </p>
      <p class="text-sm md:text-xl lora- italic font-bold text-[#B9C37B]">and vibrant moments captured from across Sri Lanka.</p>

    </div>


    <div class="md:w-full flex flex-col md:flex-row  md:space-x-4 md:space-y-4 md:px-24">

      <div class="md:w-1/4 md:h-full md:flex md:flex-col md:space-y-4">
        <div class="md:w-full md:h-[200px]">
          <img src="./assetes/images/bg36.png" alt="Alluring Tours" class="md:h-[200px] md:w-full">

        </div>
        <div class="md:w-full text-center flex justify-center items-center border border-[#B9C37B] p-4 md:p-6 bg-[#B9C37B80] md:w-full">
          <div class="md:w-full md:h-full flex items-start justify-center">
            <h3 class="md:text-xl text-black">Travel isn’t about the destination, but the memories made along the way.</h3>
          </div>

        </div>
        <div class="md:w-full md:h-[300px]">
          <img src="./assetes/images/bg39.png" alt="Alluring Tours" class="md:h-[300px] md:w-full">

        </div>

      </div>
      <div class="md:w-3/4 md:h-full md:flex md:flex-col md:space-y-4">
        <div class="md:w-full md:h-1/3 flex flex-col md:flex-row md:h-auto md:space-x-4">
          <div class="md:w-1/2 md:h-[200px]">
            <img src="./assetes/images/bg45.png" alt="Alluring Tours" class="md:h-[200px] md:w-full">

          </div>
          <div class="md:w-1/4 text-center flex flex-col md:flex-row md:h-[200px] justify-center items-center border border-[#B9C37B] p-4 md:p-6 bg-[#B9C37B80]">
            <div class="md:w-full flex flex-col md:flex-row md:items-start justify-center">
              <h3 class="md:text-xl text-black">Happiness is… a passport full of stamps and a heart full of memories.</h3>
            </div>

          </div>
          <div class="md:w-1/2 md:h-[200px]">
            <img src="./assetes/images/bg44.png" alt="Alluring Tours" class="md:h-[200px] md:w-full">

          </div>

        </div>
        <div class="md:w-full md:h-2/3 flex flex-col md:flex-row md:h-auto md:space-x-4">
          <div class="md:w-1/4 md:flex md:flex-col md:h-[400px] md:space-y-4">
            <img src="./assetes/images/bg41.png" alt="Alluring Tours" class="xl:h-[300px] w-full xl:w-full">
            <div class="md:w-full md:flex md:h-[100px] justify-center items-center border border-[#B9C37B] p-4 md:p-6 bg-[#B9C37B80]">
              <div class="md:w-full md:flex md:items-start justify-center">
                <h3 class="md:text-xl text-black text-center">Collect memories, not things – explore Sri Lanka with us!</h3>
              </div>

            </div>
          </div>
          <div class="md:w-3/4 md:flex md:flex-col md:h-[400px] md:space-y-4">
            <div class="md:w-full md:flex md:space-x-4">
              <div class="md:w-1/2 md:h-[200px]">
                <img src="./assetes/images/bg40.png" alt="Alluring Tours" class="md:h-[200px] md:w-full">
              </div>
              <div class="md:w-1/2 md:h-[200px]">
                <img src="./assetes/images/bg38.png" alt="Alluring Tours" class="md:h-[200px] md:w-full">
              </div>
            </div>

            <div class="md:w-full md:flex md:space-x-4">
              <div class="md:w-full md:h-[200px]">
                <img src="./assetes/images/bg56.png" alt="Alluring Tours" class="md:h-[200px] md:w-full">

              </div>
              <div class="md:w-1/2 md:flex md:h-[200px] justify-center items-center border border-[#B9C37B] p-4 md:p-6 bg-[#B9C37B80]">
                <div class="md:w-full md:flex md:items-start justify-center">
                  <h3 class="md:text-xl text-black text-center">Let the beauty of Sri Lanka take your breath away and fill your soul with adventure.</h3>
                </div>
  ...
  <!-- add the video in a user friendly way and should be responsive -->
  <div class="w-full bg-[#222222] flex flex-col justify-center items-center py-12">
    <h2 class="text-3xl lg:text-5xl text-white font-bold" style="font-family: 'Lora', serif;">OUR VIDEO</h2>
    <p class="text-lg lg:text-2xl mt-4 text-gray-300" style="font-family: 'Lora', serif;">Experience the beauty of Sri Lanka through our lens.</p>
    <div class="w-full flex justify-center items-center mt-8">
      <iframe class="w-full h-[300px] md:h-[500px] lg:h-[600px]" src="assetes/videos/tours.mp4" frameborder="0" allowfullscreen></iframe>
    </div>
  </div>
